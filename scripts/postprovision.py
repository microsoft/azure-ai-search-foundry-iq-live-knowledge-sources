...
def write_summary(settings: dict[str, str], smoke: dict[str, Any]) -> Path:
    ...
    lines = [
        ...
        f"SEARCH_API_VERSION={settings.get('AZURE_SEARCH_API_VERSION', SUPPORTED_SEARCH_API_VERSION)}",
...
def main() -> None:
    ...
    settings = {
        ...
        "AZURE_SEARCH_API_VERSION": get_setting(
            "AZURE_SEARCH_API_VERSION",
            azd_values,
            SUPPORTED_SEARCH_API_VERSION,
        ),
